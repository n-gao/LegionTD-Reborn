...
function Game.GetUnitNameByID(id)
  ...
  elseif id == 16 then return "tower_elementalbuilder_waterbender"
  elseif id == 17 then return "tower_elementalbuilder_thunderbender"
  elseif id == 18 then return "tower_elementalbuilder_earthbender"
  elseif id == 19 then return "tower_elementalbuilder_firebender"
  elseif id == 20 then return "tower_elementalbuilder_voidbender"
  elseif id == 21 then return "tower_elementalbuilder_waterelemental"
  elseif id == 22 then return "tower_elementalbuilder_waterwarrior"
  elseif id == 23 then return "tower_elementalbuilder_watergod"
  elseif id == 24 then return "tower_elementalbuilder_earthelemental"
  elseif id == 25 then return "tower_elementalbuilder_earthwarrior"
  elseif id == 26 then return "tower_elementalbuilder_earthgod"
  elseif id == 27 then return "tower_elementalbuilder_thunderelemental"
  elseif id == 28 then return "tower_elementalbuilder_thunderwarrior"
  elseif id == 29 then return "tower_elementalbuilder_thundergod"
  elseif id == 30 then return "tower_elementalbuilder_fireelemental"
  elseif id == 31 then return "tower_elementalbuilder_firewarrior"
  elseif id == 32 then return "tower_elementalbuilder_firegod"
  elseif id == 33 then return "tower_elementalbuilder_voidelemental"
  elseif id == 34 then return "tower_elementalbuilder_voidwarrior"
  elseif id == 35 then return "tower_elementalbuilder_voidgod"
