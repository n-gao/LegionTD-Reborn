...
function Game.GetUnitNameByID(id)
  ...
  elseif id == 9001 then return "tower_demonbuilder_imp"
  elseif id == 9002 then return "tower_demonbuilder_dog"
  elseif id == 9003 then return "tower_demonbuilder_imp2"
  elseif id == 9004 then return "tower_demonbuilder_imp3"
  elseif id == 9005 then return "tower_demonbuilder_imp4"
  elseif id == 9006 then return "tower_demonbuilder_imp5"
  elseif id == 9007 then return "tower_demonbuilder_imp6"
  elseif id == 9008 then return "tower_demonbuilder_imp7"
  elseif id == 9009 then return "tower_demonbuilder_imp8"
  elseif id == 9010 then return "tower_demonbuilder_imp9"
  elseif id == 9011 then return "tower_demonbuilder_imp10"
  elseif id == 9012 then return "tower_demonbuilder_imp11"
  elseif id == 9013 then return "tower_demonbuilder_imp12"
  elseif id == 9014 then return "tower_demonbuilder_imp13"
  elseif id == 9015 then return "tower_demonbuilder_imp14"
  elseif id == 9016 then return "tower_demonbuilder_imp15"
  elseif id == 9017 then return "tower_demonbuilder_imp16"
  elseif id == 9018 then return "tower_demonbuilder_imp17"
  elseif id == 9019 then return "tower_demonbuilder_imp18"
  elseif id == 9020 then return "tower_demonbuilder_imp19"
  elseif id == 9021 then return "tower_demonbuilder_imp20"
