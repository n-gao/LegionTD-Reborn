improved_pudge_rot_lua = class({})
LinkLuaModifier( "modifier_rot_lua", "abilities/modifier_rot_lua.lua" ,LUA_MODIFIER_MOTION_NONE )
...
function improved_pudge_rot_lua:ProcsMagicStick()
	return false
end

--------------------------------------------------------------------------------

function improved_pudge_rot_lua:OnToggle()
