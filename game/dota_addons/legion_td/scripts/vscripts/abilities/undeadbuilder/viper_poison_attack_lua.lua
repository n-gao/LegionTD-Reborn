...
LinkLuaModifier( "modifier_generic_orb_effect_lua", "abilities/undeadbuilder/modifier_generic_orb_effect_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_viper_poison_attack_lua", "abilities/undeadbuilder/modifier_viper_poison_attack_lua", LUA_MODIFIER_MOTION_NONE )
