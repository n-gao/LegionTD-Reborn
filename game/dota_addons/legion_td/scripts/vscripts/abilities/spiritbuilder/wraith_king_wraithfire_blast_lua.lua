...
LinkLuaModifier("modifier_generic_stunned_lua", "abilities/modifier_generic_stunned_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_wraith_king_wraithfire_blast_lua_slow", "abilities/spiritbuilder/modifier_wraith_king_wraithfire_blast_lua_slow", LUA_MODIFIER_MOTION_NONE )
