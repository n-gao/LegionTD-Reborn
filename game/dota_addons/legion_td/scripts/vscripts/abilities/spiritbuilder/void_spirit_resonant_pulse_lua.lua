...
LinkLuaModifier( "modifier_generic_ring_lua", "abilities/modifier_generic_ring_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_void_spirit_resonant_pulse_lua", "abilities/spiritbuilder/modifier_void_spirit_resonant_pulse_lua", LUA_MODIFIER_MOTION_NONE )
