...
RequiredUnits = {
	...
	"tower_kingLeoric_creeping_shadow",
	"tower_kingLeoric_jester",
	"tower_kingLeoric_lotus",
	"tower_kingLeoric_mind_stealer",
	"tower_kingLeoric_zealot_scarab",
	"tower_kingLeoric_alpha_predator",
	"tower_kingLeoric_bloodknife",
	"tower_kingLeoric_blood_drinker",
	"tower_kingLeoric_dark_wraith",
	"tower_kingLeoric_mind_breaker",
	"tower_kingLeoric_mind_slicer",
	"tower_kingLeoric_nightshade",
	"tower_kingLeoric_nimble_edge",
	"tower_kingLeoric_shadow_hunter",
	"tower_kingLeoric_silent_champion",
	"tower_kingLeoric_stealth_assassin",
	"tower_kingLeoric_timekeeper",
	"tower_kingLeoric_trickster",
}
