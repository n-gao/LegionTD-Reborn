...
function Unit.GetUnitNameByID(id)
    ...
    elseif id == 300 then return "tower_assassinbuilder_creeping_shadow"
    elseif id == 301 then return "tower_assassinbuilder_jester"
    elseif id == 302 then return "tower_assassinbuilder_lotus"
    elseif id == 303 then return "tower_assassinbuilder_mind_stealer"
    elseif id == 304 then return "tower_assassinbuilder_zealot_scarab"
    elseif id == 305 then return "tower_assassinbuilder_alpha_predator"
    elseif id == 306 then return "tower_assassinbuilder_bloodknife"
    elseif id == 307 then return "tower_assassinbuilder_blood_drinker"
    elseif id == 308 then return "tower_assassinbuilder_dark_wraith"
    elseif id == 309 then return "tower_assassinbuilder_mind_breaker"
    elseif id == 310 then return "tower_assassinbuilder_mind_slicer"
    elseif id == 311 then return "tower_assassinbuilder_nightshade"
    elseif id == 312 then return "tower_assassinbuilder_nimble_edge"
    elseif id == 313 then return "tower_assassinbuilder_shadow_hunter"
    elseif id == 314 then return "tower_assassinbuilder_silent_champion"
    elseif id == 315 then return "tower_assassinbuilder_stealth_assassin"
    elseif id == 316 then return "tower_assassinbuilder_timekeeper"
    elseif id == 317 then return "tower_assassinbuilder_trickster"
 
    elseif id == 400 then return "tower_undeadbuilder_zombie"
    elseif id == 401 then return "tower_undeadbuilder_butcher"
    elseif id == 402 then return "tower_undeadbuilder_nether_drake"
    elseif id == 403 then return "tower_undeadbuilder_vampire"
    elseif id == 404 then return "tower_undeadbuilder_acolyte"
    elseif id == 405 then return "tower_undeadbuilder_golem"
    elseif id == 406 then return "tower_undeadbuilder_corrupted_golem"
    elseif id == 407 then return "tower_undeadbuilder_abomination"
    elseif id == 408 then return "tower_undeadbuilder_devourer"
    elseif id == 409 then return "tower_undeadbuilder_greater_zombie"
    elseif id == 410 then return "tower_undeadbuilder_flesh_ripper"
    elseif id == 411 then return "tower_undeadbuilder_mutilated_butcher"
    elseif id == 412 then return "tower_undeadbuilder_disciple"
    elseif id == 413 then return "tower_undeadbuilder_follower"
    elseif id == 414 then return "tower_undeadbuilder_recomposer"
    elseif id == 415 then return "tower_undeadbuilder_cultist"
    elseif id == 416 then return "tower_undeadbuilder_interrupter"
    elseif id == 417 then return "tower_undeadbuilder_greater_vampire"
    elseif id == 418 then return "tower_undeadbuilder_vampire_king"
    elseif id == 419 then return "tower_undeadbuilder_lifestealer"
    elseif id == 420 then return "tower_undeadbuilder_consumer"
    elseif id == 421 then return "tower_undeadbuilder_tormented_soul"
    elseif id == 422 then return "tower_undeadbuilder_evil_spirit"
    elseif id == 423 then return "tower_undeadbuilder_tormentor"
    elseif id == 424 then return "tower_undeadbuilder_the_forgotten_one"
    elseif id == 425 then return "tower_undeadbuilder_corruptor"
    elseif id == 426 then return "tower_undeadbuilder_possessed_corruptor"
