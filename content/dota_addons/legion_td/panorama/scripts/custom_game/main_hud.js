...
GameUI.CustomUIConfig().units =  new Array(
	...
	{id : 1017, cost : 350, income : 10, cooldown : 10, name : "incomeunit_black_drake", icon : "send_incomeunit_black_drake"},
	{id : 1018, cost : 380, income : 10, cooldown : 10, name : "incomeunit_big_lizard", icon : "send_incomeunit_big_lizard"},
	{id : 1019, cost : 400, income : 10, cooldown : 10, name : "incomeunit_ancientgolem", icon : "send_incomeunit_ancient_golem"},
	{id : 1020, cost : 440, income : 10, cooldown : 10, name : "incomeunit_fleshgolem", icon : "send_incomeunit_fleshgolem"},
	{id : 1021, cost : 450, income : 10, cooldown : 10, name : "incomeunit_jellyfish", icon : "send_incomeunit_jellyfish"},
	...
	{id : 1025, cost : 600, income : 12, cooldown : 10, name : "incomeunit_roshan", icon : "send_incomeunit_rosh"}
);
