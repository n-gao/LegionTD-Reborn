...
function UpdatePlayerInfo(data) {
	_ScoreboardUpdater_UpdateAllTeamsAndPlayers(scoreboard.scoreboardConfig, scoreboard.scoreboardPanel);
}
...
function _ScoreboardUpdater_UpdatePlayerPanel(scoreboardConfig, playersContainer, playerId, localPlayerTeamId) {
	...
	if (playerInfo) {
		var morePlayerInfo = GameUI.CustomUIConfig().morePlayerInfos[playerId]
